...
namespace wan24.Core
{
    ...
    public static partial class StreamHelper
    {
        ...
        /// <param name="objType">Serialized object type</param>
        ...
        {
            Type type = typeof(T);
            // Write items with an abstract serialization type
            ...
            // Write items with a non-abstract serialization type
            switch (objType)
            {
