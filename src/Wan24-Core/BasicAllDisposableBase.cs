...
namespace wan24.Core
{
    ...
    /// </summary>
    public abstract class BasicAllDisposableBase : IBasicDisposableObject, IDisposable, IAsyncDisposable
    {
        /// <summary>
        ...
        protected BasicAllDisposableBase(in bool allowFinalizer = false)
        {
            AllowFinalizer = allowFinalizer;
            if (CreateStackInfo) StackInfo = new StackInfo<BasicAllDisposableBase>(this);
        }
