...
{
    // Extensions
    public partial class ImmutableArrayEnumerable<T>
    {
        /// <summary>
        /// Where
        /// </summary>
        ...
        public virtual ImmutableArrayWhereEnumerable<T> Where(Func<T, bool> predicate) => new(Array, predicate, Offset, Length);
        ...
        /// <returns>Enumerable</returns>
        public virtual ImmutableArraySelectEnumerable<T, tResult> Select<tResult>(Func<T, tResult> selector) => new(Array, selector, Offset, Length);
        ...
        /// <param name="predicate">Predicate</param>
        /// <returns>Enumerable</returns>
        public virtual ImmutableArrayEnumerable<T> SkipWhile(Func<T, bool> predicate)
        {
            ImmutableArray<T> data = Array;
            for (int i = Offset, len = i + Length; i < len; i++)
                if (!predicate(data[i]))
        ...
        /// <param name="predicate">Predicate</param>
        /// <returns>Enumerable</returns>
        public virtual ImmutableArrayEnumerable<T> TakeWhile(Func<T, bool> predicate)
        {
            ImmutableArray<T> data = Array;
            for (int i = Offset, len = i + Length; i < len; i++)
                if (!predicate(data[i]))
