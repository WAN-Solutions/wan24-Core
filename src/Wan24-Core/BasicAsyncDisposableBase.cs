...
namespace wan24.Core
{
    ...
    /// </summary>
    public abstract class BasicAsyncDisposableBase : IBasicDisposableObject, IAsyncDisposable
    {
        /// <summary>
        ...
        protected BasicAsyncDisposableBase(in bool allowFinalizer = false)
        {
            AllowFinalizer = allowFinalizer;
            if (CreateStackInfo) StackInfo = new StackInfo<BasicAsyncDisposableBase>(this);
        }
