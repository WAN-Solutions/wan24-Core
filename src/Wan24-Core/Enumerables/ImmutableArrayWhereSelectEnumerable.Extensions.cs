...
{
    // Extensions
    public partial class ImmutableArrayWhereSelectEnumerable<tItem, tResult>
    {
        /// <summary>
        /// Select
        /// </summary>
        ...
        public virtual ImmutableArrayWhereSelectEnumerable<tItem, tResult2> Select<tResult2>(Func<tResult, tResult2> selector)
        ...
        /// <returns>Enumerable</returns>
        public virtual ImmutableArrayWhereSelectEnumerable<tItem, tResult> SkipWhile(Func<tResult, bool> predicate)
        {
            ImmutableArray<tItem> data = Array;
            tItem item;
            for (int i = Offset, len = i + Length, cnt = 0; i < len; i++)
        ...
        /// <param name="predicate">Predicate</param>
        /// <returns>Enumerable</returns>
        public virtual ImmutableArrayWhereSelectEnumerable<tItem, tResult> TakeWhile(Func<tResult, bool> predicate)
        {
            ImmutableArray<tItem> data = Array;
            tItem item;
            for (int i = Offset, len = i + Length, cnt = 0; i < len; i++)
