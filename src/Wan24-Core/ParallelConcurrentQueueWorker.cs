...
namespace wan24.Core
{
    ...
    /// </summary>
    public class ParallelConcurrentQueueWorker : ConcurrentQueueWorker, IParallelConcurrentQueueWorker
    {
        /// <summary>
        ...
        public ParallelConcurrentQueueWorker(in int threads) : base()
        {
