...
{
    /// <summary>
    /// Array WHERE + SELECT enumerator
    /// </summary>
    /// <typeparam name="tItem">Item type</typeparam>
    /// <typeparam name="tResult">Result type</typeparam>
    public class ArrayWhereSelectEnumerator<tItem, tResult> : EnumeratorBase<tResult>
    {
        /// <summary>
        /// Array
        /// </summary>
        ...
        public ArrayWhereSelectEnumerator(in tItem[] arr, in Func<tItem, bool> predicate, in Func<tItem, tResult> selector, in int offset = 0, in int? count = null) : base()
        {
            Array = arr;
