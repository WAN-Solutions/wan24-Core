...
namespace wan24.Core
{
    ...
    public static class ArgumentValidationExtensions
    {
        ...
        public static void EnsureValidArgument<T>(this T obj, string arg, int min, int max, int value, string? error = null)
        ...
        /// <param name="error">Error message</param>
        /// <exception cref="ArgumentOutOfRangeException">The given value is not in the range</exception>
        public static void EnsureValidArgument<T>(this T obj, string arg, long min, long max, long value, string? error = null)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
        ...
        /// <param name="error">Error message</param>
        /// <exception cref="ArgumentOutOfRangeException">The given value is not in the range</exception>
        public static void EnsureValidArgument<T>(this T obj, string arg, double min, double max, double value, string? error = null)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
        ...
        public static void EnsureValidArgument<T>(this T obj, string arg, string? value, string? error = null)
        ...
        /// <param name="error">Error message</param>
        /// <exception cref="ArgumentNullException">The value is <see langword="null"/></exception>
        public static void EnsureValidArgument<tObj, tValue>(this tObj obj, string arg, tValue? value, string? error = null)
            => ArgumentValidationHelper.EnsureValidArgument(arg, value, error);
        ...
        public static void EnsureValidArgument<T>(this T obj, string arg, int max, string? value, int min = 0, bool allowWhiteSpace = true, string? error = null)
        ...
        /// <exception cref="ArgumentNullException">The value is <see langword="null"/></exception>
        /// <exception cref="ArgumentOutOfRangeException">The value length isn't within the allowed range</exception>
        public static void EnsureValidArgument<tObj, tItem>(this tObj obj, string arg, int min, int max, tItem[]? value, string? error = null)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
        ...
        /// <param name="error">Error message</param>
        /// <exception cref="ArgumentOutOfRangeException">The value length isn't within the allowed range</exception>
        public static void EnsureValidArgument<tObj, tItem>(this tObj obj, string arg, int min, int max, Span<tItem> value, string? error = null)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
    }
}
