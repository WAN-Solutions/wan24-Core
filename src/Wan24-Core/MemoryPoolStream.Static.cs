...
namespace wan24.Core
{
    ...
    public partial class MemoryPoolStream
    {
        ...
        /// <param name="ms"><see cref="MemoryPoolStream"/></param>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static implicit operator ReadOnlySequence<byte>(in MemoryPoolStream ms) => ms.ToReadOnlySequence();
        ...
        /// <param name="ms"><see cref="MemoryPoolStream"/></param>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static implicit operator long(in MemoryPoolStream ms) => ms._Length;
    }
}
