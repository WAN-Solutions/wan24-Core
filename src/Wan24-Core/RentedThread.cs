...
namespace wan24.Core
{
    ...
    public class RentedThread : SimpleDisposableBase, IObjectPoolItem
    {
        ...
        /// Worker completion
        /// </summary>
        protected volatile TaskCompletionSource? WorkerCompletion = null;
        /// <summary>
        ...
        /// Current worker task
        /// </summary>
        public Task? CurrentWorkerTask => IfUndisposed(WorkerCompletion?.Task);
        ...
        public virtual async Task WorkAsync(Worker_Delegate worker, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                await WorkerCompletion.Task.DynamicContext();
            }
            finally
            {
        ...
        protected virtual void ThreadWorker()
        {
            ...
            try
            {
                while (EnsureUndisposed())
                {
                    ...
                    try
                    {
                        using CancellationTokenSource cancellation = cts.Token.CombineWith(WorkerCancellation);
        ...
        public delegate void Worker_Delegate(RentedThread thread, CancellationToken cancellationToken);
    }
}
