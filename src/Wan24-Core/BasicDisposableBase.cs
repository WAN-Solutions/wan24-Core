...
namespace wan24.Core
{
    ...
    /// </summary>
    public abstract class BasicDisposableBase : IBasicDisposableObject, IDisposable
    {
        /// <summary>
        ...
        protected BasicDisposableBase(in bool allowFinalizer = false)
        {
            AllowFinalizer = allowFinalizer;
            if(CreateStackInfo) StackInfo = new StackInfo<BasicDisposableBase>(this);
        }
