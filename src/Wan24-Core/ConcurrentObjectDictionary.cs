...
namespace wan24.Core
{
    ...
    public class ConcurrentObjectDictionary<T> : ConcurrentDictionary<T, object?> where T : notnull
    {
        ...
        /// Constructor
        /// </summary>
        public ConcurrentObjectDictionary() : base() { }
        ...
        public ConcurrentObjectDictionary(in int concurrencyLevel, in int capacity):base(concurrencyLevel, capacity) { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="items">Items</param>
        public ConcurrentObjectDictionary(in IEnumerable<KeyValuePair<T, object?>> items) : base(items) { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="items">Items</param>
        public ConcurrentObjectDictionary(in IDictionary<T, object?> items) : base(items) { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="comparer">Comparer</param>
        public ConcurrentObjectDictionary(in IEqualityComparer<T> comparer) : base(comparer) { }
        ...
        /// <param name="items">Items</param>
        /// <param name="comparer">Comparer</param>
        public ConcurrentObjectDictionary(in IEnumerable<KeyValuePair<T, object?>> items, in IEqualityComparer<T> comparer) : base(items, comparer) { }
        ...
        /// <param name="items">Items</param>
        /// <param name="comparer">Comparer</param>
        public ConcurrentObjectDictionary(in IDictionary<T, object?> items, in IEqualityComparer<T> comparer) : base(items, comparer) { }
        ...
        /// <param name="capacity">Capacity</param>
        /// <param name="comparer">Comparer</param>
        public ConcurrentObjectDictionary(in int concurrencyLevel, in int capacity, in IEqualityComparer<T> comparer) : base(concurrencyLevel, capacity, comparer) { }
        ...
        [TargetedPatchingOptOut("Tiny method")]
        public static implicit operator int(in ConcurrentObjectDictionary<T> dict) => dict.Count;
    }
}
