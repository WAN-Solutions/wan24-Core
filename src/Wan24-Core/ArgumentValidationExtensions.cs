...
namespace wan24.Core
{
    ...
    public static class ArgumentValidationExtensions
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">The given value is not in the range</exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static int EnsureValidArgument<T>(this T obj, string arg, int min, int max, int value, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
        ...
        /// <exception cref="ArgumentOutOfRangeException">The given value is not in the range</exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static long EnsureValidArgument<T>(this T obj, string arg, long min, long max, long value, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
        ...
        /// <exception cref="ArgumentOutOfRangeException">The given value is not in the range</exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static double EnsureValidArgument<T>(this T obj, string arg, double min, double max, double value, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
        ...
        /// <exception cref="ArgumentException">The condition wasn't met</exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static void EnsureValidArgument<T>(this T obj, string arg, bool condition, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgument(arg, condition, error);
        ...
        /// <param name="error">Error message</param>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static void EnsureValidArgumentRange<T>(this T obj, string arg, bool inRange, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgumentRange(arg, inRange, error);
        ...
        /// <exception cref="ArgumentException">The value contains only whitespace(s)</exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static string EnsureValidArgument<T>(this T obj, string arg, string? value, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgument(arg, value, error);
        ...
        /// <exception cref="ArgumentNullException">The value is <see langword="null"/></exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static tValue EnsureValidArgument<tObj, tValue>(this tObj obj, string arg, tValue? value, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgument(arg, value, error);
        ...
        /// <exception cref="ArgumentOutOfRangeException">The value length isn't within the allowed range</exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static string EnsureValidArgument<T>(this T obj, string arg, int max, string? value, Func<string> error, int min = 0, bool allowWhiteSpace = true)
            => ArgumentValidationHelper.EnsureValidArgument(arg, max, value, error, min, allowWhiteSpace);
        ...
        /// <exception cref="ArgumentOutOfRangeException">The value length isn't within the allowed range</exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static tItem[] EnsureValidArgument<tObj, tItem>(this tObj obj, string arg, int min, int max, tItem[]? value, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
        ...
        /// <exception cref="ArgumentOutOfRangeException">The value length isn't within the allowed range</exception>
        [TargetedPatchingOptOut("Just a method adapter")]
        public static Span<tItem> EnsureValidArgument<tObj, tItem>(this tObj obj, string arg, int min, int max, Span<tItem> value, Func<string> error)
            => ArgumentValidationHelper.EnsureValidArgument(arg, min, max, value, error);
    }
}
