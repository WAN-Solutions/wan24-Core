...
namespace wan24.Core
{
    ...
    public readonly record struct OptionValue<t1, t2, t3, t4, t5, t6, t7, t8>
    {
        ...
        /// </summary>
        /// <param name="value">Value</param>
        public OptionValue(in t8 value)
        {
            ArgumentNullException.ThrowIfNull(value);
            _Value = value;
        ...
        /// Value
        /// </summary>
        public t8 ValueAsT8 => (t8)(_Value ?? throw new InvalidOperationException());

        /// <summary>
        /// Cast as value
        /// </summary>
        /// <param name="value">Value</param>
        public static implicit operator t1(in OptionValue<t1, t2, t3, t4, t5, t6, t7, t8> value) => value.ValueAsT1;

        /// <summary>
        /// Cast as value
        /// </summary>
        /// <param name="value">Value</param>
        public static implicit operator t2(in OptionValue<t1, t2, t3, t4, t5, t6, t7, t8> value) => value.ValueAsT2;

        /// <summary>
        /// Cast as value
        /// </summary>
        /// <param name="value">Value</param>
        public static implicit operator t3(in OptionValue<t1, t2, t3, t4, t5, t6, t7, t8> value) => value.ValueAsT3;

        /// <summary>
        /// Cast as value
        /// </summary>
        /// <param name="value">Value</param>
        public static implicit operator t4(in OptionValue<t1, t2, t3, t4, t5, t6, t7, t8> value) => value.ValueAsT4;

        /// <summary>
        /// Cast as value
        /// </summary>
        /// <param name="value">Value</param>
        public static implicit operator t5(in OptionValue<t1, t2, t3, t4, t5, t6, t7, t8> value) => value.ValueAsT5;

        /// <summary>
        /// Cast as value
        /// </summary>
        /// <param name="value">Value</param>
        public static implicit operator t6(in OptionValue<t1, t2, t3, t4, t5, t6, t7, t8> value) => value.ValueAsT6;

        /// <summary>
        /// Cast as value
        /// </summary>
        /// <param name="value">Value</param>
        public static implicit operator t7(in OptionValue<t1, t2, t3, t4, t5, t6, t7, t8> value) => value.ValueAsT7;

        /// <summary>
        /// Cast as value
        /// </summary>
        /// <param name="value">Value</param>
        public static implicit operator t8(in OptionValue<t1, t2, t3, t4, t5, t6, t7, t8> value) => value.ValueAsT8;
    }
}
