...
{
    /// <summary>
    /// Memory pool stream (stores in memory from a <see cref="MemoryPool{T}"/>)
    /// </summary>
    public partial class MemoryPoolStream : StreamBase, IStatusProvider
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public MemoryPoolStream(MemoryPool<byte>? pool = null, in int? bufferSize = null) : base()
        {
        ...
        /// <param name="pool">Pool</param>
        /// <param name="bufferSize">Buffer size in bytes</param>
        public MemoryPoolStream(in IMemoryOwner<byte> data, in bool returnData, int len = -1, MemoryPool<byte>? pool = null, in int? bufferSize = null) : base()
        {
        ...
        /// <param name="pool">Pool</param>
        /// <param name="bufferSize">Buffer size in bytes</param>
        public MemoryPoolStream(in ReadOnlyMemory<byte> data, in MemoryPool<byte>? pool = null, in int? bufferSize = null) : this(data.Span, pool, bufferSize) { }
        ...
        /// <param name="pool">Pool</param>
        /// <param name="bufferSize">Buffer size in bytes</param>
        public MemoryPoolStream(in byte[] data, in MemoryPool<byte>? pool = null, in int? bufferSize = null) : this(data.AsSpan(), pool, bufferSize) { }
        ...
        public void Optimize()
        {
            ...
            {
                buffers[firstRemoved..].DisposeAll();
            }
